// Khởi tạo bộ nhớ tạm để kiểm soát cooldown
...
module.exports = function ({ api, models, Users, Threads, Currencies }) {
    return function ({ event }) {
        ...
        // Nếu đang trong cooldown, không xử lý tiếp
        if (cooldowns.has(threadID)) return;
        ...
        if (handleReply.length !== 0) {
            ...
            try {
                ...
                // Gắn cooldown 3 giây cho threadID
                cooldowns.set(threadID, true);
                setTimeout(() => cooldowns.delete(threadID), 3000);
